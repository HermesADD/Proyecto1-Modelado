...
/**
 * Clase que muestra la ejecucion en el idioma espanol Mexico
 * 
 * @author Hermes
 * @author Steve
 * @author Emiliano
...
public class EspanolMexico implements Idioma{
    ...
    @Override
    public void saludar() {
        Colors.println("Bienvenido a CheemsMart amig@!!!", Colors.GREEN);
    }
    ...
    public void compraSegura(ClienteProxy usuario) {
        ...
        Colors.println("Solo tienes una oportunidad", Colors.HIGH_INTENSITY);
